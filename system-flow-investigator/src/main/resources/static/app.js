...
const dashboardMqttEvents = document.getElementById('dashboardMqttEvents');
...
const dashboardRateTrendDetails = document.getElementById('dashboardRateTrendDetails');
